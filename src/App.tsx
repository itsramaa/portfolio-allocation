      ...
      >
        ...
        <header className="app-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <div className="app-header-actions" style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
            ...
            {isDemoMode ? (
              <button
                type="button"
                className="btn btn-sm btn-primary mono header-main-action"
              ...
              <button
                type="button"
                className="btn btn-sm btn-ghost mono header-main-action"
        ...
        {offlineMode && (
          <div
            ...
            style={{
              padding: '0.75rem 1.25rem',
              background: 'oklch(18% 0.03 240 / 0.6)',
              border: '1px solid oklch(55% 0.01 240 / 0.35)',
              borderRadius: '0.625rem',
              display: 'flex',
              alignItems: 'center',
              gap: '0.75rem',
          ...
          >
            <span style={{ fontSize: '1.1rem' }}>🔌</span>
            <span style={{ color: 'oklch(75% 0.01 240)', flex: 1 }}>
              <strong style={{ color: 'oklch(90% 0.01 240)' }}>Offline / Demo Mode:</strong>{' '}
              Backend server not detected. Running on local demo data — no API key or internet connection required.
            </span>
            <span
              style={{
                fontSize: '0.68rem',
                ...
                border: '1px solid oklch(40% 0.01 240 / 0.5)',
