---
name: clean-comments
description: Use when writing, fixing, editing, or reviewing code comments and documentation, in any programming language. Enforces Clean Code principles—no metadata, no redundancy, no commented-out code.
---
...
Use this skill when writing, fixing, editing, or reviewing code comments and documentation, in any programming language.

Also trigger on: commented-out code blocks, TODO/FIXME banners, author/ticket/date metadata in comments or docs, documentation that no longer matches the code, redundant comments that restate the code (e.g. `i += 1; // increment i`), or asks like "is this comment useful", "why is this block commented".
